...
urlpatterns = [
    path('users/me/', CurrentUserView.as_view(), name='current_user'),  # Informacje o zalogowanym użytkowniku
     path('change-password/', ChangePasswordView.as_view(), name='change_password'),    path('token/', TokenObtainPairView.as_view(), name='token_obtain_pair'),
